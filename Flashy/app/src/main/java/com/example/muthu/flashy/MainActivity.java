...
public class MainActivity extends AppCompatPreferenceActivity {
    ...
    static Boolean isNotifEnabled = false;
    /**
                ...
                if(state==TelephonyManager.CALL_STATE_RINGING)
                {
                    ...
                    for (int i = 0; i < myString.length(); i++) {
                        if (myString.charAt(i) == '0') {
                            //on
                            FlashLightHelper.handleActionTurnOnFlashLight(getApplicationContext());
                        } else {
                            //off
                            FlashLightHelper.handleActionTurnOffFlashLight(getApplicationContext());
                        }
                        try {
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if(preferenceManager != null)
                ...
                if (preferenceManager.getSharedPreferences().getBoolean("notifications_new_message", true)){
                    // Your switch is on
                    isNotifEnabled = true;
